...
%=========================================================================
    ...
    % --------------------------------------------------------------------
    mac_blood(1)    = 2.278e-1;                % blood @  50 keV   [cm2/g]
    mac_blood(2)    = 1.492e-1;                % blood @ 150 keV   [cm2/g]
    
    mac_bone(1)     = 4.242e-1;                % bone @  50 keV    [cm2/g]
    mac_bone(2)     = 1.480e-1;                % bone @ 150 keV    [cm2/g]
    
    mac_lung(1)     = 2.270e-1;                % lung @  50 keV    [cm2/g]
    mac_lung(2)     = 1.493e-1;                % lung @ 150 keV    [cm2/g]
    
    mac_muscle(1)   = 2.262e-1;                % muscle @  50 keV  [cm2/g]
    mac_muscle(2)   = 1.492e-1;                % muscle @ 150 keV  [cm2/g]
    ...
    idx = 1; if ua==100 idx = 2; end        % set ua dependent index
