...
function [] = NUC_EXERCISE1()
    ...
    mac_blood(2)    = 0.09598;                % blood  @ xxx keV  [cm2/g]
    mac_bone(1)     = 0.186;                % bone   @ 100 keV  [cm2/g]
    mac_bone(2)     = 0.09022;                % bone   @ xxx keV  [cm2/g]
    mac_lung(1)     = 0.154;                % lung   @ 100 keV  [cm2/g]
    mac_lung(2)     = 0.09607;                % lung   @ xxx keV  [cm2/g]
    mac_muscle(1)   = 0.169;                % muscle @ 100 keV  [cm2/g]
    mac_muscle(2)   = 0.09598;                % muscle @ xxx keV  [cm2/g]
    mac_water(1)    = 0.171;                % water  @ 100 keV  [cm2/g]
    mac_water(2)    = 0.09687;                % water  @ xxx keV  [cm2/g]
    % --------------------------------------------------------------------
    ...
    % --------------------------------------------------------------------
    % Task 1.3. fprintf('PET tumor activity ground truth: %f\n',CalcROISignal(phantom,9,phantom.discrete));
    ...
    slope = (mue_bone(2) - mue_water(2))/(mue_bone(1) - mue_water(1));    
    phantom.corr = mue_bone(2) + (phantom.ctfbp - mue_bone(1)).* slope;
